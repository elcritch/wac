...
void thunk_out_0_ii(Module *m, Block *function, Type *type) {
    ((void (*)(uint32_t, uint32_t))function->func_ptr)(
        m->stack[m->sp - 1].value.uint32, m->stack[m->sp - 0].value.uint32);
    m->sp = m->sp + -2;
}

void thunk_out_0_iii(Module *m, Block *function, Type *type) {
    ((void (*)(uint32_t, uint32_t, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.uint32);
    m->sp = m->sp + -3;
}

void thunk_out_0_iiI(Module *m, Block *function, Type *type) {
    ((void (*)(uint32_t, uint32_t, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.uint64);
    m->sp = m->sp + -3;
}

void thunk_out_0_iif(Module *m, Block *function, Type *type) {
    ((void (*)(uint32_t, uint32_t, float))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.f32);
    m->sp = m->sp + -3;
}

void thunk_out_0_iiF(Module *m, Block *function, Type *type) {
    ((void (*)(uint32_t, uint32_t, double))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.f64);
    m->sp = m->sp + -3;
}

void thunk_out_0_iI(Module *m, Block *function, Type *type) {
    ((void (*)(uint32_t, uint64_t))function->func_ptr)(
        m->stack[m->sp - 1].value.uint32, m->stack[m->sp - 0].value.uint64);
    m->sp = m->sp + -2;
}

void thunk_out_0_iIi(Module *m, Block *function, Type *type) {
    ((void (*)(uint32_t, uint64_t, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.uint32);
    m->sp = m->sp + -3;
}

void thunk_out_0_iII(Module *m, Block *function, Type *type) {
    ((void (*)(uint32_t, uint64_t, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.uint64);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_iIf(Module *m, Block *function, Type *type) {
    ((void (*)(uint32_t, uint64_t, float))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.f32);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_iIF(Module *m, Block *function, Type *type) {
    ((void (*)(uint32_t, uint64_t, double))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.f64);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_if(Module *m, Block *function, Type *type) {
    ((void (*)(uint32_t, float))function->func_ptr)(
        m->stack[m->sp - 1].value.uint32, m->stack[m->sp - 0].value.f32);
    m->sp = m->sp + -2;
}

void thunk_out_0_ifi(Module *m, Block *function, Type *type) {
    ((void (*)(uint32_t, float, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.uint32);
    m->sp = m->sp + -3;
}

void thunk_out_0_ifI(Module *m, Block *function, Type *type) {
    ((void (*)(uint32_t, float, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.uint64);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_iff(Module *m, Block *function, Type *type) {
    ((void (*)(uint32_t, float, float))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.f32);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_ifF(Module *m, Block *function, Type *type) {
    ((void (*)(uint32_t, float, double))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.f64);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_iF(Module *m, Block *function, Type *type) {
    ((void (*)(uint32_t, double))function->func_ptr)(
        m->stack[m->sp - 1].value.uint32, m->stack[m->sp - 0].value.f64);
    m->sp = m->sp + -2;
}

void thunk_out_0_iFi(Module *m, Block *function, Type *type) {
    ((void (*)(uint32_t, double, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.uint32);
    m->sp = m->sp + -3;
}

void thunk_out_0_iFI(Module *m, Block *function, Type *type) {
    ((void (*)(uint32_t, double, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.uint64);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_iFf(Module *m, Block *function, Type *type) {
    ((void (*)(uint32_t, double, float))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.f32);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_iFF(Module *m, Block *function, Type *type) {
    ((void (*)(uint32_t, double, double))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.f64);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_Ii(Module *m, Block *function, Type *type) {
    ((void (*)(uint64_t, uint32_t))function->func_ptr)(
        m->stack[m->sp - 1].value.uint64, m->stack[m->sp - 0].value.uint32);
    m->sp = m->sp + -2;
}

void thunk_out_0_Iii(Module *m, Block *function, Type *type) {
    ((void (*)(uint64_t, uint32_t, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.uint32);
    m->sp = m->sp + -3;
}

void thunk_out_0_IiI(Module *m, Block *function, Type *type) {
    ((void (*)(uint64_t, uint32_t, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.uint64);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_Iif(Module *m, Block *function, Type *type) {
    ((void (*)(uint64_t, uint32_t, float))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.f32);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_IiF(Module *m, Block *function, Type *type) {
    ((void (*)(uint64_t, uint32_t, double))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.f64);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_II(Module *m, Block *function, Type *type) {
    ((void (*)(uint64_t, uint64_t))function->func_ptr)(
        m->stack[m->sp - 1].value.uint64, m->stack[m->sp - 0].value.uint64);
    m->sp = m->sp + -2;
}

void thunk_out_0_IIi(Module *m, Block *function, Type *type) {
    ((void (*)(uint64_t, uint64_t, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.uint32);
    m->sp = m->sp + -3;
}

void thunk_out_0_III(Module *m, Block *function, Type *type) {
    ((void (*)(uint64_t, uint64_t, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.uint64);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_IIf(Module *m, Block *function, Type *type) {
    ((void (*)(uint64_t, uint64_t, float))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.f32);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_IIF(Module *m, Block *function, Type *type) {
    ((void (*)(uint64_t, uint64_t, double))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.f64);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_If(Module *m, Block *function, Type *type) {
    ((void (*)(uint64_t, float))function->func_ptr)(
        m->stack[m->sp - 1].value.uint64, m->stack[m->sp - 0].value.f32);
    m->sp = m->sp + -2;
}

void thunk_out_0_Ifi(Module *m, Block *function, Type *type) {
    ((void (*)(uint64_t, float, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.uint32);
    m->sp = m->sp + -3;
}

void thunk_out_0_IfI(Module *m, Block *function, Type *type) {
    ((void (*)(uint64_t, float, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.uint64);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_Iff(Module *m, Block *function, Type *type) {
    ((void (*)(uint64_t, float, float))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.f32);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_IfF(Module *m, Block *function, Type *type) {
    ((void (*)(uint64_t, float, double))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.f64);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_IF(Module *m, Block *function, Type *type) {
    ((void (*)(uint64_t, double))function->func_ptr)(
        m->stack[m->sp - 1].value.uint64, m->stack[m->sp - 0].value.f64);
    m->sp = m->sp + -2;
}

void thunk_out_0_IFi(Module *m, Block *function, Type *type) {
    ((void (*)(uint64_t, double, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.uint32);
    m->sp = m->sp + -3;
}

void thunk_out_0_IFI(Module *m, Block *function, Type *type) {
    ((void (*)(uint64_t, double, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.uint64);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_IFf(Module *m, Block *function, Type *type) {
    ((void (*)(uint64_t, double, float))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.f32);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_IFF(Module *m, Block *function, Type *type) {
    ((void (*)(uint64_t, double, double))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.f64);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_fi(Module *m, Block *function, Type *type) {
    ((void (*)(float, uint32_t))function->func_ptr)(
        m->stack[m->sp - 1].value.f32, m->stack[m->sp - 0].value.uint32);
    m->sp = m->sp + -2;
}

void thunk_out_0_fii(Module *m, Block *function, Type *type) {
    ((void (*)(float, uint32_t, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.uint32);
    m->sp = m->sp + -3;
}

void thunk_out_0_fiI(Module *m, Block *function, Type *type) {
    ((void (*)(float, uint32_t, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.uint64);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_fif(Module *m, Block *function, Type *type) {
    ((void (*)(float, uint32_t, float))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.f32);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_fiF(Module *m, Block *function, Type *type) {
    ((void (*)(float, uint32_t, double))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.f64);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_fI(Module *m, Block *function, Type *type) {
    ((void (*)(float, uint64_t))function->func_ptr)(
        m->stack[m->sp - 1].value.f32, m->stack[m->sp - 0].value.uint64);
    m->sp = m->sp + -2;
}

void thunk_out_0_fIi(Module *m, Block *function, Type *type) {
    ((void (*)(float, uint64_t, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.uint32);
    m->sp = m->sp + -3;
}

void thunk_out_0_fII(Module *m, Block *function, Type *type) {
    ((void (*)(float, uint64_t, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.uint64);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_fIf(Module *m, Block *function, Type *type) {
    ((void (*)(float, uint64_t, float))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.f32);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_fIF(Module *m, Block *function, Type *type) {
    ((void (*)(float, uint64_t, double))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.f64);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_ff(Module *m, Block *function, Type *type) {
    ((void (*)(float, float))function->func_ptr)(m->stack[m->sp - 1].value.f32,
                                                 m->stack[m->sp - 0].value.f32);
    m->sp = m->sp + -2;
}

void thunk_out_0_ffi(Module *m, Block *function, Type *type) {
    ((void (*)(float, float, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.uint32);
    m->sp = m->sp + -3;
}

void thunk_out_0_ffI(Module *m, Block *function, Type *type) {
    ((void (*)(float, float, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.uint64);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_fff(Module *m, Block *function, Type *type) {
    ((void (*)(float, float, float))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.f32);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_ffF(Module *m, Block *function, Type *type) {
    ((void (*)(float, float, double))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.f64);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_fF(Module *m, Block *function, Type *type) {
    ((void (*)(float, double))function->func_ptr)(
        m->stack[m->sp - 1].value.f32, m->stack[m->sp - 0].value.f64);
    m->sp = m->sp + -2;
}

void thunk_out_0_fFi(Module *m, Block *function, Type *type) {
    ((void (*)(float, double, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.uint32);
    m->sp = m->sp + -3;
}

void thunk_out_0_fFI(Module *m, Block *function, Type *type) {
    ((void (*)(float, double, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.uint64);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_fFf(Module *m, Block *function, Type *type) {
    ((void (*)(float, double, float))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.f32);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_fFF(Module *m, Block *function, Type *type) {
    ((void (*)(float, double, double))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.f64);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_Fi(Module *m, Block *function, Type *type) {
    ((void (*)(double, uint32_t))function->func_ptr)(
        m->stack[m->sp - 1].value.f64, m->stack[m->sp - 0].value.uint32);
    m->sp = m->sp + -2;
}

void thunk_out_0_Fii(Module *m, Block *function, Type *type) {
    ((void (*)(double, uint32_t, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.uint32);
    m->sp = m->sp + -3;
}

void thunk_out_0_FiI(Module *m, Block *function, Type *type) {
    ((void (*)(double, uint32_t, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.uint64);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_Fif(Module *m, Block *function, Type *type) {
    ((void (*)(double, uint32_t, float))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.f32);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_FiF(Module *m, Block *function, Type *type) {
    ((void (*)(double, uint32_t, double))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.f64);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_FI(Module *m, Block *function, Type *type) {
    ((void (*)(double, uint64_t))function->func_ptr)(
        m->stack[m->sp - 1].value.f64, m->stack[m->sp - 0].value.uint64);
    m->sp = m->sp + -2;
}

void thunk_out_0_FIi(Module *m, Block *function, Type *type) {
    ((void (*)(double, uint64_t, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.uint32);
    m->sp = m->sp + -3;
}

void thunk_out_0_FII(Module *m, Block *function, Type *type) {
    ((void (*)(double, uint64_t, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.uint64);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_FIf(Module *m, Block *function, Type *type) {
    ((void (*)(double, uint64_t, float))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.f32);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_FIF(Module *m, Block *function, Type *type) {
    ((void (*)(double, uint64_t, double))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.f64);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_Ff(Module *m, Block *function, Type *type) {
    ((void (*)(double, float))function->func_ptr)(
        m->stack[m->sp - 1].value.f64, m->stack[m->sp - 0].value.f32);
    m->sp = m->sp + -2;
}

void thunk_out_0_Ffi(Module *m, Block *function, Type *type) {
    ((void (*)(double, float, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.uint32);
    m->sp = m->sp + -3;
}

void thunk_out_0_FfI(Module *m, Block *function, Type *type) {
    ((void (*)(double, float, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.uint64);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_Fff(Module *m, Block *function, Type *type) {
    ((void (*)(double, float, float))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.f32);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_FfF(Module *m, Block *function, Type *type) {
    ((void (*)(double, float, double))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.f64);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_FF(Module *m, Block *function, Type *type) {
    ((void (*)(double, double))function->func_ptr)(
        m->stack[m->sp - 1].value.f64, m->stack[m->sp - 0].value.f64);
    m->sp = m->sp + -2;
}

void thunk_out_0_FFi(Module *m, Block *function, Type *type) {
    ((void (*)(double, double, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.uint32);
    m->sp = m->sp + -3;
}

void thunk_out_0_FFI(Module *m, Block *function, Type *type) {
    ((void (*)(double, double, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.uint64);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_FFf(Module *m, Block *function, Type *type) {
    ((void (*)(double, double, float))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.f32);
    m->sp = m->sp + -3;
}
...
void thunk_out_0_FFF(Module *m, Block *function, Type *type) {
    ((void (*)(double, double, double))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.f64);
    m->sp = m->sp + -3;
}
...
void thunk_out_i_i(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(uint32_t))function->func_ptr)(
        m->stack[m->sp - 0].value.uint32);
    m->sp += 0;
    m->stack[m->sp].value_type = I32;
    m->stack[m->sp].value.uint32 = res;
...
void thunk_out_i_ii(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(uint32_t, uint32_t))function->func_ptr)(
        m->stack[m->sp - 1].value.uint32, m->stack[m->sp - 0].value.uint32);
    m->sp += -1;
    m->stack[m->sp].value_type = I32;
    m->stack[m->sp].value.uint32 = res;
...
void thunk_out_i_iii(Module *m, Block *function, Type *type) {
    uint32_t res =
        ((uint32_t(*)(uint32_t, uint32_t, uint32_t))function->func_ptr)(
            m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.uint32,
            m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_iiI(Module *m, Block *function, Type *type) {
    uint32_t res =
        ((uint32_t(*)(uint32_t, uint32_t, uint64_t))function->func_ptr)(
            m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.uint32,
            m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_iif(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(uint32_t, uint32_t, float))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_iiF(Module *m, Block *function, Type *type) {
    uint32_t res =
        ((uint32_t(*)(uint32_t, uint32_t, double))function->func_ptr)(
            m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.uint32,
            m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_iI(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(uint32_t, uint64_t))function->func_ptr)(
        m->stack[m->sp - 1].value.uint32, m->stack[m->sp - 0].value.uint64);
    m->sp += -1;
    m->stack[m->sp].value_type = I32;
    m->stack[m->sp].value.uint32 = res;
...
void thunk_out_i_iIi(Module *m, Block *function, Type *type) {
    uint32_t res =
        ((uint32_t(*)(uint32_t, uint64_t, uint32_t))function->func_ptr)(
            m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.uint64,
            m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_iII(Module *m, Block *function, Type *type) {
    uint32_t res =
        ((uint32_t(*)(uint32_t, uint64_t, uint64_t))function->func_ptr)(
            m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.uint64,
            m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_iIf(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(uint32_t, uint64_t, float))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_iIF(Module *m, Block *function, Type *type) {
    uint32_t res =
        ((uint32_t(*)(uint32_t, uint64_t, double))function->func_ptr)(
            m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.uint64,
            m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_if(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(uint32_t, float))function->func_ptr)(
        m->stack[m->sp - 1].value.uint32, m->stack[m->sp - 0].value.f32);
    m->sp += -1;
    m->stack[m->sp].value_type = I32;
    m->stack[m->sp].value.uint32 = res;
...
void thunk_out_i_ifi(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(uint32_t, float, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_ifI(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(uint32_t, float, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_iff(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(uint32_t, float, float))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_ifF(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(uint32_t, float, double))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_iF(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(uint32_t, double))function->func_ptr)(
        m->stack[m->sp - 1].value.uint32, m->stack[m->sp - 0].value.f64);
    m->sp += -1;
    m->stack[m->sp].value_type = I32;
    m->stack[m->sp].value.uint32 = res;
...
void thunk_out_i_iFi(Module *m, Block *function, Type *type) {
    uint32_t res =
        ((uint32_t(*)(uint32_t, double, uint32_t))function->func_ptr)(
            m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.f64,
            m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_iFI(Module *m, Block *function, Type *type) {
    uint32_t res =
        ((uint32_t(*)(uint32_t, double, uint64_t))function->func_ptr)(
            m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.f64,
            m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_iFf(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(uint32_t, double, float))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_iFF(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(uint32_t, double, double))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_I(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(uint64_t))function->func_ptr)(
        m->stack[m->sp - 0].value.uint64);
    m->sp += 0;
    m->stack[m->sp].value_type = I32;
    m->stack[m->sp].value.uint32 = res;
...
void thunk_out_i_Ii(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(uint64_t, uint32_t))function->func_ptr)(
        m->stack[m->sp - 1].value.uint64, m->stack[m->sp - 0].value.uint32);
    m->sp += -1;
    m->stack[m->sp].value_type = I32;
    m->stack[m->sp].value.uint32 = res;
...
void thunk_out_i_Iii(Module *m, Block *function, Type *type) {
    uint32_t res =
        ((uint32_t(*)(uint64_t, uint32_t, uint32_t))function->func_ptr)(
            m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.uint32,
            m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_IiI(Module *m, Block *function, Type *type) {
    uint32_t res =
        ((uint32_t(*)(uint64_t, uint32_t, uint64_t))function->func_ptr)(
            m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.uint32,
            m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_Iif(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(uint64_t, uint32_t, float))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_IiF(Module *m, Block *function, Type *type) {
    uint32_t res =
        ((uint32_t(*)(uint64_t, uint32_t, double))function->func_ptr)(
            m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.uint32,
            m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_II(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(uint64_t, uint64_t))function->func_ptr)(
        m->stack[m->sp - 1].value.uint64, m->stack[m->sp - 0].value.uint64);
    m->sp += -1;
    m->stack[m->sp].value_type = I32;
    m->stack[m->sp].value.uint32 = res;
...
void thunk_out_i_IIi(Module *m, Block *function, Type *type) {
    uint32_t res =
        ((uint32_t(*)(uint64_t, uint64_t, uint32_t))function->func_ptr)(
            m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.uint64,
            m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_III(Module *m, Block *function, Type *type) {
    uint32_t res =
        ((uint32_t(*)(uint64_t, uint64_t, uint64_t))function->func_ptr)(
            m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.uint64,
            m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_IIf(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(uint64_t, uint64_t, float))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_IIF(Module *m, Block *function, Type *type) {
    uint32_t res =
        ((uint32_t(*)(uint64_t, uint64_t, double))function->func_ptr)(
            m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.uint64,
            m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_If(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(uint64_t, float))function->func_ptr)(
        m->stack[m->sp - 1].value.uint64, m->stack[m->sp - 0].value.f32);
    m->sp += -1;
    m->stack[m->sp].value_type = I32;
    m->stack[m->sp].value.uint32 = res;
...
void thunk_out_i_Ifi(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(uint64_t, float, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_IfI(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(uint64_t, float, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_Iff(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(uint64_t, float, float))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_IfF(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(uint64_t, float, double))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_IF(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(uint64_t, double))function->func_ptr)(
        m->stack[m->sp - 1].value.uint64, m->stack[m->sp - 0].value.f64);
    m->sp += -1;
    m->stack[m->sp].value_type = I32;
    m->stack[m->sp].value.uint32 = res;
...
void thunk_out_i_IFi(Module *m, Block *function, Type *type) {
    uint32_t res =
        ((uint32_t(*)(uint64_t, double, uint32_t))function->func_ptr)(
            m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.f64,
            m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_IFI(Module *m, Block *function, Type *type) {
    uint32_t res =
        ((uint32_t(*)(uint64_t, double, uint64_t))function->func_ptr)(
            m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.f64,
            m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_IFf(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(uint64_t, double, float))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_IFF(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(uint64_t, double, double))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_f(Module *m, Block *function, Type *type) {
    uint32_t res =
        ((uint32_t(*)(float))function->func_ptr)(m->stack[m->sp - 0].value.f32);
    m->sp += 0;
    m->stack[m->sp].value_type = I32;
    m->stack[m->sp].value.uint32 = res;
}
...
void thunk_out_i_fi(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(float, uint32_t))function->func_ptr)(
        m->stack[m->sp - 1].value.f32, m->stack[m->sp - 0].value.uint32);
    m->sp += -1;
    m->stack[m->sp].value_type = I32;
    m->stack[m->sp].value.uint32 = res;
...
void thunk_out_i_fii(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(float, uint32_t, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_fiI(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(float, uint32_t, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_fif(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(float, uint32_t, float))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_fiF(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(float, uint32_t, double))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_fI(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(float, uint64_t))function->func_ptr)(
        m->stack[m->sp - 1].value.f32, m->stack[m->sp - 0].value.uint64);
    m->sp += -1;
    m->stack[m->sp].value_type = I32;
    m->stack[m->sp].value.uint32 = res;
...
void thunk_out_i_fIi(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(float, uint64_t, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_fII(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(float, uint64_t, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_fIf(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(float, uint64_t, float))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_fIF(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(float, uint64_t, double))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_ff(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(float, float))function->func_ptr)(
        m->stack[m->sp - 1].value.f32, m->stack[m->sp - 0].value.f32);
    m->sp += -1;
    m->stack[m->sp].value_type = I32;
    m->stack[m->sp].value.uint32 = res;
}
...
void thunk_out_i_ffi(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(float, float, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_ffI(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(float, float, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_fff(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(float, float, float))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_ffF(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(float, float, double))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_fF(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(float, double))function->func_ptr)(
        m->stack[m->sp - 1].value.f32, m->stack[m->sp - 0].value.f64);
    m->sp += -1;
    m->stack[m->sp].value_type = I32;
    m->stack[m->sp].value.uint32 = res;
...
void thunk_out_i_fFi(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(float, double, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_fFI(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(float, double, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_fFf(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(float, double, float))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_fFF(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(float, double, double))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_F(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(double))function->func_ptr)(
        m->stack[m->sp - 0].value.f64);
    m->sp += 0;
    m->stack[m->sp].value_type = I32;
    m->stack[m->sp].value.uint32 = res;
...
void thunk_out_i_Fi(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(double, uint32_t))function->func_ptr)(
        m->stack[m->sp - 1].value.f64, m->stack[m->sp - 0].value.uint32);
    m->sp += -1;
    m->stack[m->sp].value_type = I32;
    m->stack[m->sp].value.uint32 = res;
...
void thunk_out_i_Fii(Module *m, Block *function, Type *type) {
    uint32_t res =
        ((uint32_t(*)(double, uint32_t, uint32_t))function->func_ptr)(
            m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.uint32,
            m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_FiI(Module *m, Block *function, Type *type) {
    uint32_t res =
        ((uint32_t(*)(double, uint32_t, uint64_t))function->func_ptr)(
            m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.uint32,
            m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_Fif(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(double, uint32_t, float))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_FiF(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(double, uint32_t, double))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_FI(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(double, uint64_t))function->func_ptr)(
        m->stack[m->sp - 1].value.f64, m->stack[m->sp - 0].value.uint64);
    m->sp += -1;
    m->stack[m->sp].value_type = I32;
    m->stack[m->sp].value.uint32 = res;
...
void thunk_out_i_FIi(Module *m, Block *function, Type *type) {
    uint32_t res =
        ((uint32_t(*)(double, uint64_t, uint32_t))function->func_ptr)(
            m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.uint64,
            m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_FII(Module *m, Block *function, Type *type) {
    uint32_t res =
        ((uint32_t(*)(double, uint64_t, uint64_t))function->func_ptr)(
            m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.uint64,
            m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_FIf(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(double, uint64_t, float))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_FIF(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(double, uint64_t, double))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_Ff(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(double, float))function->func_ptr)(
        m->stack[m->sp - 1].value.f64, m->stack[m->sp - 0].value.f32);
    m->sp += -1;
    m->stack[m->sp].value_type = I32;
    m->stack[m->sp].value.uint32 = res;
...
void thunk_out_i_Ffi(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(double, float, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_FfI(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(double, float, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_Fff(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(double, float, float))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_FfF(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(double, float, double))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_FF(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(double, double))function->func_ptr)(
        m->stack[m->sp - 1].value.f64, m->stack[m->sp - 0].value.f64);
    m->sp += -1;
    m->stack[m->sp].value_type = I32;
    m->stack[m->sp].value.uint32 = res;
...
void thunk_out_i_FFi(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(double, double, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_FFI(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(double, double, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_FFf(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(double, double, float))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_FFF(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(double, double, double))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_I_i(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(uint32_t))function->func_ptr)(
        m->stack[m->sp - 0].value.uint32);
    m->sp += 0;
    m->stack[m->sp].value_type = I64;
    m->stack[m->sp].value.uint64 = res;
...
void thunk_out_I_ii(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(uint32_t, uint32_t))function->func_ptr)(
        m->stack[m->sp - 1].value.uint32, m->stack[m->sp - 0].value.uint32);
    m->sp += -1;
    m->stack[m->sp].value_type = I64;
    m->stack[m->sp].value.uint64 = res;
...
void thunk_out_I_iii(Module *m, Block *function, Type *type) {
    uint64_t res =
        ((uint64_t(*)(uint32_t, uint32_t, uint32_t))function->func_ptr)(
            m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.uint32,
            m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_iiI(Module *m, Block *function, Type *type) {
    uint64_t res =
        ((uint64_t(*)(uint32_t, uint32_t, uint64_t))function->func_ptr)(
            m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.uint32,
            m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_iif(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(uint32_t, uint32_t, float))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_iiF(Module *m, Block *function, Type *type) {
    uint64_t res =
        ((uint64_t(*)(uint32_t, uint32_t, double))function->func_ptr)(
            m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.uint32,
            m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_iI(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(uint32_t, uint64_t))function->func_ptr)(
        m->stack[m->sp - 1].value.uint32, m->stack[m->sp - 0].value.uint64);
    m->sp += -1;
    m->stack[m->sp].value_type = I64;
    m->stack[m->sp].value.uint64 = res;
...
void thunk_out_I_iIi(Module *m, Block *function, Type *type) {
    uint64_t res =
        ((uint64_t(*)(uint32_t, uint64_t, uint32_t))function->func_ptr)(
            m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.uint64,
            m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_iII(Module *m, Block *function, Type *type) {
    uint64_t res =
        ((uint64_t(*)(uint32_t, uint64_t, uint64_t))function->func_ptr)(
            m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.uint64,
            m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_iIf(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(uint32_t, uint64_t, float))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_iIF(Module *m, Block *function, Type *type) {
    uint64_t res =
        ((uint64_t(*)(uint32_t, uint64_t, double))function->func_ptr)(
            m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.uint64,
            m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_if(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(uint32_t, float))function->func_ptr)(
        m->stack[m->sp - 1].value.uint32, m->stack[m->sp - 0].value.f32);
    m->sp += -1;
    m->stack[m->sp].value_type = I64;
    m->stack[m->sp].value.uint64 = res;
...
void thunk_out_I_ifi(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(uint32_t, float, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_ifI(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(uint32_t, float, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_iff(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(uint32_t, float, float))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_ifF(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(uint32_t, float, double))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_iF(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(uint32_t, double))function->func_ptr)(
        m->stack[m->sp - 1].value.uint32, m->stack[m->sp - 0].value.f64);
    m->sp += -1;
    m->stack[m->sp].value_type = I64;
    m->stack[m->sp].value.uint64 = res;
...
void thunk_out_I_iFi(Module *m, Block *function, Type *type) {
    uint64_t res =
        ((uint64_t(*)(uint32_t, double, uint32_t))function->func_ptr)(
            m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.f64,
            m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_iFI(Module *m, Block *function, Type *type) {
    uint64_t res =
        ((uint64_t(*)(uint32_t, double, uint64_t))function->func_ptr)(
            m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.f64,
            m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_iFf(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(uint32_t, double, float))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_iFF(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(uint32_t, double, double))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_I(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(uint64_t))function->func_ptr)(
        m->stack[m->sp - 0].value.uint64);
    m->sp += 0;
    m->stack[m->sp].value_type = I64;
    m->stack[m->sp].value.uint64 = res;
...
void thunk_out_I_Ii(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(uint64_t, uint32_t))function->func_ptr)(
        m->stack[m->sp - 1].value.uint64, m->stack[m->sp - 0].value.uint32);
    m->sp += -1;
    m->stack[m->sp].value_type = I64;
    m->stack[m->sp].value.uint64 = res;
...
void thunk_out_I_Iii(Module *m, Block *function, Type *type) {
    uint64_t res =
        ((uint64_t(*)(uint64_t, uint32_t, uint32_t))function->func_ptr)(
            m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.uint32,
            m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_IiI(Module *m, Block *function, Type *type) {
    uint64_t res =
        ((uint64_t(*)(uint64_t, uint32_t, uint64_t))function->func_ptr)(
            m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.uint32,
            m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_Iif(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(uint64_t, uint32_t, float))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_IiF(Module *m, Block *function, Type *type) {
    uint64_t res =
        ((uint64_t(*)(uint64_t, uint32_t, double))function->func_ptr)(
            m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.uint32,
            m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_II(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(uint64_t, uint64_t))function->func_ptr)(
        m->stack[m->sp - 1].value.uint64, m->stack[m->sp - 0].value.uint64);
    m->sp += -1;
    m->stack[m->sp].value_type = I64;
    m->stack[m->sp].value.uint64 = res;
...
void thunk_out_I_IIi(Module *m, Block *function, Type *type) {
    uint64_t res =
        ((uint64_t(*)(uint64_t, uint64_t, uint32_t))function->func_ptr)(
            m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.uint64,
            m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_III(Module *m, Block *function, Type *type) {
    uint64_t res =
        ((uint64_t(*)(uint64_t, uint64_t, uint64_t))function->func_ptr)(
            m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.uint64,
            m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_IIf(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(uint64_t, uint64_t, float))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_IIF(Module *m, Block *function, Type *type) {
    uint64_t res =
        ((uint64_t(*)(uint64_t, uint64_t, double))function->func_ptr)(
            m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.uint64,
            m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_If(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(uint64_t, float))function->func_ptr)(
        m->stack[m->sp - 1].value.uint64, m->stack[m->sp - 0].value.f32);
    m->sp += -1;
    m->stack[m->sp].value_type = I64;
    m->stack[m->sp].value.uint64 = res;
...
void thunk_out_I_Ifi(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(uint64_t, float, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_IfI(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(uint64_t, float, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_Iff(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(uint64_t, float, float))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_IfF(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(uint64_t, float, double))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_IF(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(uint64_t, double))function->func_ptr)(
        m->stack[m->sp - 1].value.uint64, m->stack[m->sp - 0].value.f64);
    m->sp += -1;
    m->stack[m->sp].value_type = I64;
    m->stack[m->sp].value.uint64 = res;
...
void thunk_out_I_IFi(Module *m, Block *function, Type *type) {
    uint64_t res =
        ((uint64_t(*)(uint64_t, double, uint32_t))function->func_ptr)(
            m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.f64,
            m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_IFI(Module *m, Block *function, Type *type) {
    uint64_t res =
        ((uint64_t(*)(uint64_t, double, uint64_t))function->func_ptr)(
            m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.f64,
            m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_IFf(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(uint64_t, double, float))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_IFF(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(uint64_t, double, double))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_f(Module *m, Block *function, Type *type) {
    uint64_t res =
        ((uint64_t(*)(float))function->func_ptr)(m->stack[m->sp - 0].value.f32);
    m->sp += 0;
    m->stack[m->sp].value_type = I64;
    m->stack[m->sp].value.uint64 = res;
}
...
void thunk_out_I_fi(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(float, uint32_t))function->func_ptr)(
        m->stack[m->sp - 1].value.f32, m->stack[m->sp - 0].value.uint32);
    m->sp += -1;
    m->stack[m->sp].value_type = I64;
    m->stack[m->sp].value.uint64 = res;
...
void thunk_out_I_fii(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(float, uint32_t, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_fiI(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(float, uint32_t, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_fif(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(float, uint32_t, float))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_fiF(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(float, uint32_t, double))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_fI(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(float, uint64_t))function->func_ptr)(
        m->stack[m->sp - 1].value.f32, m->stack[m->sp - 0].value.uint64);
    m->sp += -1;
    m->stack[m->sp].value_type = I64;
    m->stack[m->sp].value.uint64 = res;
...
void thunk_out_I_fIi(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(float, uint64_t, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_fII(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(float, uint64_t, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_fIf(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(float, uint64_t, float))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_fIF(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(float, uint64_t, double))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_ff(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(float, float))function->func_ptr)(
        m->stack[m->sp - 1].value.f32, m->stack[m->sp - 0].value.f32);
    m->sp += -1;
    m->stack[m->sp].value_type = I64;
    m->stack[m->sp].value.uint64 = res;
...
void thunk_out_I_ffi(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(float, float, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_ffI(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(float, float, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_fff(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(float, float, float))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_ffF(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(float, float, double))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_fF(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(float, double))function->func_ptr)(
        m->stack[m->sp - 1].value.f32, m->stack[m->sp - 0].value.f64);
    m->sp += -1;
    m->stack[m->sp].value_type = I64;
    m->stack[m->sp].value.uint64 = res;
...
void thunk_out_I_fFi(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(float, double, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_fFI(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(float, double, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_fFf(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(float, double, float))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_fFF(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(float, double, double))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_F(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(double))function->func_ptr)(
        m->stack[m->sp - 0].value.f64);
    m->sp += 0;
    m->stack[m->sp].value_type = I64;
    m->stack[m->sp].value.uint64 = res;
...
void thunk_out_I_Fi(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(double, uint32_t))function->func_ptr)(
        m->stack[m->sp - 1].value.f64, m->stack[m->sp - 0].value.uint32);
    m->sp += -1;
    m->stack[m->sp].value_type = I64;
    m->stack[m->sp].value.uint64 = res;
...
void thunk_out_I_Fii(Module *m, Block *function, Type *type) {
    uint64_t res =
        ((uint64_t(*)(double, uint32_t, uint32_t))function->func_ptr)(
            m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.uint32,
            m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_FiI(Module *m, Block *function, Type *type) {
    uint64_t res =
        ((uint64_t(*)(double, uint32_t, uint64_t))function->func_ptr)(
            m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.uint32,
            m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_Fif(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(double, uint32_t, float))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_FiF(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(double, uint32_t, double))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_FI(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(double, uint64_t))function->func_ptr)(
        m->stack[m->sp - 1].value.f64, m->stack[m->sp - 0].value.uint64);
    m->sp += -1;
    m->stack[m->sp].value_type = I64;
    m->stack[m->sp].value.uint64 = res;
...
void thunk_out_I_FIi(Module *m, Block *function, Type *type) {
    uint64_t res =
        ((uint64_t(*)(double, uint64_t, uint32_t))function->func_ptr)(
            m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.uint64,
            m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_FII(Module *m, Block *function, Type *type) {
    uint64_t res =
        ((uint64_t(*)(double, uint64_t, uint64_t))function->func_ptr)(
            m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.uint64,
            m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_FIf(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(double, uint64_t, float))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_FIF(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(double, uint64_t, double))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_Ff(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(double, float))function->func_ptr)(
        m->stack[m->sp - 1].value.f64, m->stack[m->sp - 0].value.f32);
    m->sp += -1;
    m->stack[m->sp].value_type = I64;
    m->stack[m->sp].value.uint64 = res;
...
void thunk_out_I_Ffi(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(double, float, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_FfI(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(double, float, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_Fff(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(double, float, float))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_FfF(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(double, float, double))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_FF(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(double, double))function->func_ptr)(
        m->stack[m->sp - 1].value.f64, m->stack[m->sp - 0].value.f64);
    m->sp += -1;
    m->stack[m->sp].value_type = I64;
    m->stack[m->sp].value.uint64 = res;
...
void thunk_out_I_FFi(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(double, double, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_FFI(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(double, double, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_FFf(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(double, double, float))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_I_FFF(Module *m, Block *function, Type *type) {
    uint64_t res = ((uint64_t(*)(double, double, double))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = I64;
...
void thunk_out_f_i(Module *m, Block *function, Type *type) {
    float res = ((float (*)(uint32_t))function->func_ptr)(
        m->stack[m->sp - 0].value.uint32);
    m->sp += 0;
    m->stack[m->sp].value_type = F32;
    m->stack[m->sp].value.f32 = res;
...
void thunk_out_f_ii(Module *m, Block *function, Type *type) {
    float res = ((float (*)(uint32_t, uint32_t))function->func_ptr)(
        m->stack[m->sp - 1].value.uint32, m->stack[m->sp - 0].value.uint32);
    m->sp += -1;
    m->stack[m->sp].value_type = F32;
    m->stack[m->sp].value.f32 = res;
...
void thunk_out_f_iii(Module *m, Block *function, Type *type) {
    float res = ((float (*)(uint32_t, uint32_t, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_iiI(Module *m, Block *function, Type *type) {
    float res = ((float (*)(uint32_t, uint32_t, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_iif(Module *m, Block *function, Type *type) {
    float res = ((float (*)(uint32_t, uint32_t, float))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_iiF(Module *m, Block *function, Type *type) {
    float res = ((float (*)(uint32_t, uint32_t, double))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_iI(Module *m, Block *function, Type *type) {
    float res = ((float (*)(uint32_t, uint64_t))function->func_ptr)(
        m->stack[m->sp - 1].value.uint32, m->stack[m->sp - 0].value.uint64);
    m->sp += -1;
    m->stack[m->sp].value_type = F32;
    m->stack[m->sp].value.f32 = res;
...
void thunk_out_f_iIi(Module *m, Block *function, Type *type) {
    float res = ((float (*)(uint32_t, uint64_t, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_iII(Module *m, Block *function, Type *type) {
    float res = ((float (*)(uint32_t, uint64_t, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_iIf(Module *m, Block *function, Type *type) {
    float res = ((float (*)(uint32_t, uint64_t, float))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_iIF(Module *m, Block *function, Type *type) {
    float res = ((float (*)(uint32_t, uint64_t, double))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_if(Module *m, Block *function, Type *type) {
    float res = ((float (*)(uint32_t, float))function->func_ptr)(
        m->stack[m->sp - 1].value.uint32, m->stack[m->sp - 0].value.f32);
    m->sp += -1;
    m->stack[m->sp].value_type = F32;
    m->stack[m->sp].value.f32 = res;
...
void thunk_out_f_ifi(Module *m, Block *function, Type *type) {
    float res = ((float (*)(uint32_t, float, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_ifI(Module *m, Block *function, Type *type) {
    float res = ((float (*)(uint32_t, float, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_iff(Module *m, Block *function, Type *type) {
    float res = ((float (*)(uint32_t, float, float))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_ifF(Module *m, Block *function, Type *type) {
    float res = ((float (*)(uint32_t, float, double))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_iF(Module *m, Block *function, Type *type) {
    float res = ((float (*)(uint32_t, double))function->func_ptr)(
        m->stack[m->sp - 1].value.uint32, m->stack[m->sp - 0].value.f64);
    m->sp += -1;
    m->stack[m->sp].value_type = F32;
    m->stack[m->sp].value.f32 = res;
...
void thunk_out_f_iFi(Module *m, Block *function, Type *type) {
    float res = ((float (*)(uint32_t, double, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_iFI(Module *m, Block *function, Type *type) {
    float res = ((float (*)(uint32_t, double, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_iFf(Module *m, Block *function, Type *type) {
    float res = ((float (*)(uint32_t, double, float))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_iFF(Module *m, Block *function, Type *type) {
    float res = ((float (*)(uint32_t, double, double))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_I(Module *m, Block *function, Type *type) {
    float res = ((float (*)(uint64_t))function->func_ptr)(
        m->stack[m->sp - 0].value.uint64);
    m->sp += 0;
    m->stack[m->sp].value_type = F32;
    m->stack[m->sp].value.f32 = res;
...
void thunk_out_f_Ii(Module *m, Block *function, Type *type) {
    float res = ((float (*)(uint64_t, uint32_t))function->func_ptr)(
        m->stack[m->sp - 1].value.uint64, m->stack[m->sp - 0].value.uint32);
    m->sp += -1;
    m->stack[m->sp].value_type = F32;
    m->stack[m->sp].value.f32 = res;
...
void thunk_out_f_Iii(Module *m, Block *function, Type *type) {
    float res = ((float (*)(uint64_t, uint32_t, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_IiI(Module *m, Block *function, Type *type) {
    float res = ((float (*)(uint64_t, uint32_t, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_Iif(Module *m, Block *function, Type *type) {
    float res = ((float (*)(uint64_t, uint32_t, float))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_IiF(Module *m, Block *function, Type *type) {
    float res = ((float (*)(uint64_t, uint32_t, double))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_II(Module *m, Block *function, Type *type) {
    float res = ((float (*)(uint64_t, uint64_t))function->func_ptr)(
        m->stack[m->sp - 1].value.uint64, m->stack[m->sp - 0].value.uint64);
    m->sp += -1;
    m->stack[m->sp].value_type = F32;
    m->stack[m->sp].value.f32 = res;
...
void thunk_out_f_IIi(Module *m, Block *function, Type *type) {
    float res = ((float (*)(uint64_t, uint64_t, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_III(Module *m, Block *function, Type *type) {
    float res = ((float (*)(uint64_t, uint64_t, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_IIf(Module *m, Block *function, Type *type) {
    float res = ((float (*)(uint64_t, uint64_t, float))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_IIF(Module *m, Block *function, Type *type) {
    float res = ((float (*)(uint64_t, uint64_t, double))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_If(Module *m, Block *function, Type *type) {
    float res = ((float (*)(uint64_t, float))function->func_ptr)(
        m->stack[m->sp - 1].value.uint64, m->stack[m->sp - 0].value.f32);
    m->sp += -1;
    m->stack[m->sp].value_type = F32;
    m->stack[m->sp].value.f32 = res;
...
void thunk_out_f_Ifi(Module *m, Block *function, Type *type) {
    float res = ((float (*)(uint64_t, float, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_IfI(Module *m, Block *function, Type *type) {
    float res = ((float (*)(uint64_t, float, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_Iff(Module *m, Block *function, Type *type) {
    float res = ((float (*)(uint64_t, float, float))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_IfF(Module *m, Block *function, Type *type) {
    float res = ((float (*)(uint64_t, float, double))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_IF(Module *m, Block *function, Type *type) {
    float res = ((float (*)(uint64_t, double))function->func_ptr)(
        m->stack[m->sp - 1].value.uint64, m->stack[m->sp - 0].value.f64);
    m->sp += -1;
    m->stack[m->sp].value_type = F32;
    m->stack[m->sp].value.f32 = res;
...
void thunk_out_f_IFi(Module *m, Block *function, Type *type) {
    float res = ((float (*)(uint64_t, double, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_IFI(Module *m, Block *function, Type *type) {
    float res = ((float (*)(uint64_t, double, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_IFf(Module *m, Block *function, Type *type) {
    float res = ((float (*)(uint64_t, double, float))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_IFF(Module *m, Block *function, Type *type) {
    float res = ((float (*)(uint64_t, double, double))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_f(Module *m, Block *function, Type *type) {
    float res =
        ((float (*)(float))function->func_ptr)(m->stack[m->sp - 0].value.f32);
    m->sp += 0;
    m->stack[m->sp].value_type = F32;
    m->stack[m->sp].value.f32 = res;
}
...
void thunk_out_f_fi(Module *m, Block *function, Type *type) {
    float res = ((float (*)(float, uint32_t))function->func_ptr)(
        m->stack[m->sp - 1].value.f32, m->stack[m->sp - 0].value.uint32);
    m->sp += -1;
    m->stack[m->sp].value_type = F32;
    m->stack[m->sp].value.f32 = res;
...
void thunk_out_f_fii(Module *m, Block *function, Type *type) {
    float res = ((float (*)(float, uint32_t, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_fiI(Module *m, Block *function, Type *type) {
    float res = ((float (*)(float, uint32_t, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_fif(Module *m, Block *function, Type *type) {
    float res = ((float (*)(float, uint32_t, float))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_fiF(Module *m, Block *function, Type *type) {
    float res = ((float (*)(float, uint32_t, double))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_fI(Module *m, Block *function, Type *type) {
    float res = ((float (*)(float, uint64_t))function->func_ptr)(
        m->stack[m->sp - 1].value.f32, m->stack[m->sp - 0].value.uint64);
    m->sp += -1;
    m->stack[m->sp].value_type = F32;
    m->stack[m->sp].value.f32 = res;
...
void thunk_out_f_fIi(Module *m, Block *function, Type *type) {
    float res = ((float (*)(float, uint64_t, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_fII(Module *m, Block *function, Type *type) {
    float res = ((float (*)(float, uint64_t, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_fIf(Module *m, Block *function, Type *type) {
    float res = ((float (*)(float, uint64_t, float))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_fIF(Module *m, Block *function, Type *type) {
    float res = ((float (*)(float, uint64_t, double))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_ff(Module *m, Block *function, Type *type) {
    float res = ((float (*)(float, float))function->func_ptr)(
        m->stack[m->sp - 1].value.f32, m->stack[m->sp - 0].value.f32);
    m->sp += -1;
    m->stack[m->sp].value_type = F32;
    m->stack[m->sp].value.f32 = res;
...
void thunk_out_f_ffi(Module *m, Block *function, Type *type) {
    float res = ((float (*)(float, float, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_ffI(Module *m, Block *function, Type *type) {
    float res = ((float (*)(float, float, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_fff(Module *m, Block *function, Type *type) {
    float res = ((float (*)(float, float, float))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_ffF(Module *m, Block *function, Type *type) {
    float res = ((float (*)(float, float, double))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_fF(Module *m, Block *function, Type *type) {
    float res = ((float (*)(float, double))function->func_ptr)(
        m->stack[m->sp - 1].value.f32, m->stack[m->sp - 0].value.f64);
    m->sp += -1;
    m->stack[m->sp].value_type = F32;
    m->stack[m->sp].value.f32 = res;
...
void thunk_out_f_fFi(Module *m, Block *function, Type *type) {
    float res = ((float (*)(float, double, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_fFI(Module *m, Block *function, Type *type) {
    float res = ((float (*)(float, double, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_fFf(Module *m, Block *function, Type *type) {
    float res = ((float (*)(float, double, float))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_fFF(Module *m, Block *function, Type *type) {
    float res = ((float (*)(float, double, double))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_F(Module *m, Block *function, Type *type) {
    float res =
        ((float (*)(double))function->func_ptr)(m->stack[m->sp - 0].value.f64);
    m->sp += 0;
    m->stack[m->sp].value_type = F32;
    m->stack[m->sp].value.f32 = res;
}
...
void thunk_out_f_Fi(Module *m, Block *function, Type *type) {
    float res = ((float (*)(double, uint32_t))function->func_ptr)(
        m->stack[m->sp - 1].value.f64, m->stack[m->sp - 0].value.uint32);
    m->sp += -1;
    m->stack[m->sp].value_type = F32;
    m->stack[m->sp].value.f32 = res;
...
void thunk_out_f_Fii(Module *m, Block *function, Type *type) {
    float res = ((float (*)(double, uint32_t, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_FiI(Module *m, Block *function, Type *type) {
    float res = ((float (*)(double, uint32_t, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_Fif(Module *m, Block *function, Type *type) {
    float res = ((float (*)(double, uint32_t, float))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_FiF(Module *m, Block *function, Type *type) {
    float res = ((float (*)(double, uint32_t, double))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_FI(Module *m, Block *function, Type *type) {
    float res = ((float (*)(double, uint64_t))function->func_ptr)(
        m->stack[m->sp - 1].value.f64, m->stack[m->sp - 0].value.uint64);
    m->sp += -1;
    m->stack[m->sp].value_type = F32;
    m->stack[m->sp].value.f32 = res;
...
void thunk_out_f_FIi(Module *m, Block *function, Type *type) {
    float res = ((float (*)(double, uint64_t, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_FII(Module *m, Block *function, Type *type) {
    float res = ((float (*)(double, uint64_t, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_FIf(Module *m, Block *function, Type *type) {
    float res = ((float (*)(double, uint64_t, float))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_FIF(Module *m, Block *function, Type *type) {
    float res = ((float (*)(double, uint64_t, double))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_Ff(Module *m, Block *function, Type *type) {
    float res = ((float (*)(double, float))function->func_ptr)(
        m->stack[m->sp - 1].value.f64, m->stack[m->sp - 0].value.f32);
    m->sp += -1;
    m->stack[m->sp].value_type = F32;
    m->stack[m->sp].value.f32 = res;
...
void thunk_out_f_Ffi(Module *m, Block *function, Type *type) {
    float res = ((float (*)(double, float, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_FfI(Module *m, Block *function, Type *type) {
    float res = ((float (*)(double, float, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_Fff(Module *m, Block *function, Type *type) {
    float res = ((float (*)(double, float, float))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_FfF(Module *m, Block *function, Type *type) {
    float res = ((float (*)(double, float, double))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_FF(Module *m, Block *function, Type *type) {
    float res = ((float (*)(double, double))function->func_ptr)(
        m->stack[m->sp - 1].value.f64, m->stack[m->sp - 0].value.f64);
    m->sp += -1;
    m->stack[m->sp].value_type = F32;
    m->stack[m->sp].value.f32 = res;
...
void thunk_out_f_FFi(Module *m, Block *function, Type *type) {
    float res = ((float (*)(double, double, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_FFI(Module *m, Block *function, Type *type) {
    float res = ((float (*)(double, double, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_FFf(Module *m, Block *function, Type *type) {
    float res = ((float (*)(double, double, float))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_f_FFF(Module *m, Block *function, Type *type) {
    float res = ((float (*)(double, double, double))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = F32;
...
void thunk_out_F_i(Module *m, Block *function, Type *type) {
    double res = ((double (*)(uint32_t))function->func_ptr)(
        m->stack[m->sp - 0].value.uint32);
    m->sp += 0;
    m->stack[m->sp].value_type = F64;
    m->stack[m->sp].value.f64 = res;
...
void thunk_out_F_ii(Module *m, Block *function, Type *type) {
    double res = ((double (*)(uint32_t, uint32_t))function->func_ptr)(
        m->stack[m->sp - 1].value.uint32, m->stack[m->sp - 0].value.uint32);
    m->sp += -1;
    m->stack[m->sp].value_type = F64;
    m->stack[m->sp].value.f64 = res;
...
void thunk_out_F_iii(Module *m, Block *function, Type *type) {
    double res = ((double (*)(uint32_t, uint32_t, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_iiI(Module *m, Block *function, Type *type) {
    double res = ((double (*)(uint32_t, uint32_t, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_iif(Module *m, Block *function, Type *type) {
    double res = ((double (*)(uint32_t, uint32_t, float))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_iiF(Module *m, Block *function, Type *type) {
    double res = ((double (*)(uint32_t, uint32_t, double))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_iI(Module *m, Block *function, Type *type) {
    double res = ((double (*)(uint32_t, uint64_t))function->func_ptr)(
        m->stack[m->sp - 1].value.uint32, m->stack[m->sp - 0].value.uint64);
    m->sp += -1;
    m->stack[m->sp].value_type = F64;
    m->stack[m->sp].value.f64 = res;
...
void thunk_out_F_iIi(Module *m, Block *function, Type *type) {
    double res = ((double (*)(uint32_t, uint64_t, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_iII(Module *m, Block *function, Type *type) {
    double res = ((double (*)(uint32_t, uint64_t, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_iIf(Module *m, Block *function, Type *type) {
    double res = ((double (*)(uint32_t, uint64_t, float))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_iIF(Module *m, Block *function, Type *type) {
    double res = ((double (*)(uint32_t, uint64_t, double))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_if(Module *m, Block *function, Type *type) {
    double res = ((double (*)(uint32_t, float))function->func_ptr)(
        m->stack[m->sp - 1].value.uint32, m->stack[m->sp - 0].value.f32);
    m->sp += -1;
    m->stack[m->sp].value_type = F64;
    m->stack[m->sp].value.f64 = res;
...
void thunk_out_F_ifi(Module *m, Block *function, Type *type) {
    double res = ((double (*)(uint32_t, float, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_ifI(Module *m, Block *function, Type *type) {
    double res = ((double (*)(uint32_t, float, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_iff(Module *m, Block *function, Type *type) {
    double res = ((double (*)(uint32_t, float, float))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_ifF(Module *m, Block *function, Type *type) {
    double res = ((double (*)(uint32_t, float, double))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_iF(Module *m, Block *function, Type *type) {
    double res = ((double (*)(uint32_t, double))function->func_ptr)(
        m->stack[m->sp - 1].value.uint32, m->stack[m->sp - 0].value.f64);
    m->sp += -1;
    m->stack[m->sp].value_type = F64;
    m->stack[m->sp].value.f64 = res;
...
void thunk_out_F_iFi(Module *m, Block *function, Type *type) {
    double res = ((double (*)(uint32_t, double, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_iFI(Module *m, Block *function, Type *type) {
    double res = ((double (*)(uint32_t, double, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_iFf(Module *m, Block *function, Type *type) {
    double res = ((double (*)(uint32_t, double, float))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_iFF(Module *m, Block *function, Type *type) {
    double res = ((double (*)(uint32_t, double, double))function->func_ptr)(
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_I(Module *m, Block *function, Type *type) {
    double res = ((double (*)(uint64_t))function->func_ptr)(
        m->stack[m->sp - 0].value.uint64);
    m->sp += 0;
    m->stack[m->sp].value_type = F64;
    m->stack[m->sp].value.f64 = res;
...
void thunk_out_F_Ii(Module *m, Block *function, Type *type) {
    double res = ((double (*)(uint64_t, uint32_t))function->func_ptr)(
        m->stack[m->sp - 1].value.uint64, m->stack[m->sp - 0].value.uint32);
    m->sp += -1;
    m->stack[m->sp].value_type = F64;
    m->stack[m->sp].value.f64 = res;
...
void thunk_out_F_Iii(Module *m, Block *function, Type *type) {
    double res = ((double (*)(uint64_t, uint32_t, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_IiI(Module *m, Block *function, Type *type) {
    double res = ((double (*)(uint64_t, uint32_t, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_Iif(Module *m, Block *function, Type *type) {
    double res = ((double (*)(uint64_t, uint32_t, float))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_IiF(Module *m, Block *function, Type *type) {
    double res = ((double (*)(uint64_t, uint32_t, double))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_II(Module *m, Block *function, Type *type) {
    double res = ((double (*)(uint64_t, uint64_t))function->func_ptr)(
        m->stack[m->sp - 1].value.uint64, m->stack[m->sp - 0].value.uint64);
    m->sp += -1;
    m->stack[m->sp].value_type = F64;
    m->stack[m->sp].value.f64 = res;
...
void thunk_out_F_IIi(Module *m, Block *function, Type *type) {
    double res = ((double (*)(uint64_t, uint64_t, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_III(Module *m, Block *function, Type *type) {
    double res = ((double (*)(uint64_t, uint64_t, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_IIf(Module *m, Block *function, Type *type) {
    double res = ((double (*)(uint64_t, uint64_t, float))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_IIF(Module *m, Block *function, Type *type) {
    double res = ((double (*)(uint64_t, uint64_t, double))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_If(Module *m, Block *function, Type *type) {
    double res = ((double (*)(uint64_t, float))function->func_ptr)(
        m->stack[m->sp - 1].value.uint64, m->stack[m->sp - 0].value.f32);
    m->sp += -1;
    m->stack[m->sp].value_type = F64;
    m->stack[m->sp].value.f64 = res;
...
void thunk_out_F_Ifi(Module *m, Block *function, Type *type) {
    double res = ((double (*)(uint64_t, float, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_IfI(Module *m, Block *function, Type *type) {
    double res = ((double (*)(uint64_t, float, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_Iff(Module *m, Block *function, Type *type) {
    double res = ((double (*)(uint64_t, float, float))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_IfF(Module *m, Block *function, Type *type) {
    double res = ((double (*)(uint64_t, float, double))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_IF(Module *m, Block *function, Type *type) {
    double res = ((double (*)(uint64_t, double))function->func_ptr)(
        m->stack[m->sp - 1].value.uint64, m->stack[m->sp - 0].value.f64);
    m->sp += -1;
    m->stack[m->sp].value_type = F64;
    m->stack[m->sp].value.f64 = res;
...
void thunk_out_F_IFi(Module *m, Block *function, Type *type) {
    double res = ((double (*)(uint64_t, double, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_IFI(Module *m, Block *function, Type *type) {
    double res = ((double (*)(uint64_t, double, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_IFf(Module *m, Block *function, Type *type) {
    double res = ((double (*)(uint64_t, double, float))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_IFF(Module *m, Block *function, Type *type) {
    double res = ((double (*)(uint64_t, double, double))function->func_ptr)(
        m->stack[m->sp - 2].value.uint64, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_f(Module *m, Block *function, Type *type) {
    double res =
        ((double (*)(float))function->func_ptr)(m->stack[m->sp - 0].value.f32);
    m->sp += 0;
    m->stack[m->sp].value_type = F64;
    m->stack[m->sp].value.f64 = res;
}
...
void thunk_out_F_fi(Module *m, Block *function, Type *type) {
    double res = ((double (*)(float, uint32_t))function->func_ptr)(
        m->stack[m->sp - 1].value.f32, m->stack[m->sp - 0].value.uint32);
    m->sp += -1;
    m->stack[m->sp].value_type = F64;
    m->stack[m->sp].value.f64 = res;
...
void thunk_out_F_fii(Module *m, Block *function, Type *type) {
    double res = ((double (*)(float, uint32_t, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_fiI(Module *m, Block *function, Type *type) {
    double res = ((double (*)(float, uint32_t, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_fif(Module *m, Block *function, Type *type) {
    double res = ((double (*)(float, uint32_t, float))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_fiF(Module *m, Block *function, Type *type) {
    double res = ((double (*)(float, uint32_t, double))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_fI(Module *m, Block *function, Type *type) {
    double res = ((double (*)(float, uint64_t))function->func_ptr)(
        m->stack[m->sp - 1].value.f32, m->stack[m->sp - 0].value.uint64);
    m->sp += -1;
    m->stack[m->sp].value_type = F64;
    m->stack[m->sp].value.f64 = res;
...
void thunk_out_F_fIi(Module *m, Block *function, Type *type) {
    double res = ((double (*)(float, uint64_t, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_fII(Module *m, Block *function, Type *type) {
    double res = ((double (*)(float, uint64_t, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_fIf(Module *m, Block *function, Type *type) {
    double res = ((double (*)(float, uint64_t, float))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_fIF(Module *m, Block *function, Type *type) {
    double res = ((double (*)(float, uint64_t, double))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_ff(Module *m, Block *function, Type *type) {
    double res = ((double (*)(float, float))function->func_ptr)(
        m->stack[m->sp - 1].value.f32, m->stack[m->sp - 0].value.f32);
    m->sp += -1;
    m->stack[m->sp].value_type = F64;
    m->stack[m->sp].value.f64 = res;
...
void thunk_out_F_ffi(Module *m, Block *function, Type *type) {
    double res = ((double (*)(float, float, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_ffI(Module *m, Block *function, Type *type) {
    double res = ((double (*)(float, float, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_fff(Module *m, Block *function, Type *type) {
    double res = ((double (*)(float, float, float))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_ffF(Module *m, Block *function, Type *type) {
    double res = ((double (*)(float, float, double))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_fF(Module *m, Block *function, Type *type) {
    double res = ((double (*)(float, double))function->func_ptr)(
        m->stack[m->sp - 1].value.f32, m->stack[m->sp - 0].value.f64);
    m->sp += -1;
    m->stack[m->sp].value_type = F64;
    m->stack[m->sp].value.f64 = res;
...
void thunk_out_F_fFi(Module *m, Block *function, Type *type) {
    double res = ((double (*)(float, double, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_fFI(Module *m, Block *function, Type *type) {
    double res = ((double (*)(float, double, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_fFf(Module *m, Block *function, Type *type) {
    double res = ((double (*)(float, double, float))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_fFF(Module *m, Block *function, Type *type) {
    double res = ((double (*)(float, double, double))function->func_ptr)(
        m->stack[m->sp - 2].value.f32, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_F(Module *m, Block *function, Type *type) {
    double res =
        ((double (*)(double))function->func_ptr)(m->stack[m->sp - 0].value.f64);
    m->sp += 0;
    m->stack[m->sp].value_type = F64;
    m->stack[m->sp].value.f64 = res;
}
...
void thunk_out_F_Fi(Module *m, Block *function, Type *type) {
    double res = ((double (*)(double, uint32_t))function->func_ptr)(
        m->stack[m->sp - 1].value.f64, m->stack[m->sp - 0].value.uint32);
    m->sp += -1;
    m->stack[m->sp].value_type = F64;
    m->stack[m->sp].value.f64 = res;
...
void thunk_out_F_Fii(Module *m, Block *function, Type *type) {
    double res = ((double (*)(double, uint32_t, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_FiI(Module *m, Block *function, Type *type) {
    double res = ((double (*)(double, uint32_t, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_Fif(Module *m, Block *function, Type *type) {
    double res = ((double (*)(double, uint32_t, float))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_FiF(Module *m, Block *function, Type *type) {
    double res = ((double (*)(double, uint32_t, double))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_FI(Module *m, Block *function, Type *type) {
    double res = ((double (*)(double, uint64_t))function->func_ptr)(
        m->stack[m->sp - 1].value.f64, m->stack[m->sp - 0].value.uint64);
    m->sp += -1;
    m->stack[m->sp].value_type = F64;
    m->stack[m->sp].value.f64 = res;
...
void thunk_out_F_FIi(Module *m, Block *function, Type *type) {
    double res = ((double (*)(double, uint64_t, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_FII(Module *m, Block *function, Type *type) {
    double res = ((double (*)(double, uint64_t, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_FIf(Module *m, Block *function, Type *type) {
    double res = ((double (*)(double, uint64_t, float))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_FIF(Module *m, Block *function, Type *type) {
    double res = ((double (*)(double, uint64_t, double))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.uint64,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_Ff(Module *m, Block *function, Type *type) {
    double res = ((double (*)(double, float))function->func_ptr)(
        m->stack[m->sp - 1].value.f64, m->stack[m->sp - 0].value.f32);
    m->sp += -1;
    m->stack[m->sp].value_type = F64;
    m->stack[m->sp].value.f64 = res;
...
void thunk_out_F_Ffi(Module *m, Block *function, Type *type) {
    double res = ((double (*)(double, float, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_FfI(Module *m, Block *function, Type *type) {
    double res = ((double (*)(double, float, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_Fff(Module *m, Block *function, Type *type) {
    double res = ((double (*)(double, float, float))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_FfF(Module *m, Block *function, Type *type) {
    double res = ((double (*)(double, float, double))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.f32,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_FF(Module *m, Block *function, Type *type) {
    double res = ((double (*)(double, double))function->func_ptr)(
        m->stack[m->sp - 1].value.f64, m->stack[m->sp - 0].value.f64);
    m->sp += -1;
    m->stack[m->sp].value_type = F64;
    m->stack[m->sp].value.f64 = res;
...
void thunk_out_F_FFi(Module *m, Block *function, Type *type) {
    double res = ((double (*)(double, double, uint32_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_FFI(Module *m, Block *function, Type *type) {
    double res = ((double (*)(double, double, uint64_t))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.uint64);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_FFf(Module *m, Block *function, Type *type) {
    double res = ((double (*)(double, double, float))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.f32);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_F_FFF(Module *m, Block *function, Type *type) {
    double res = ((double (*)(double, double, double))function->func_ptr)(
        m->stack[m->sp - 2].value.f64, m->stack[m->sp - 1].value.f64,
        m->stack[m->sp - 0].value.f64);
    m->sp += -2;
    m->stack[m->sp].value_type = F64;
...
void thunk_out_0_iiii(Module *m, Block *function, Type *type) {
    ((void (*)(uint32_t, uint32_t, uint32_t, uint32_t))function->func_ptr)(
        m->stack[m->sp - 3].value.uint32, m->stack[m->sp - 2].value.uint32,
        m->stack[m->sp - 1].value.uint32, m->stack[m->sp - 0].value.uint32);
    m->sp = m->sp + -4;
}

void thunk_out_i_iiii(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(uint32_t, uint32_t, uint32_t,
                                 uint32_t))function->func_ptr)(
        m->stack[m->sp - 3].value.uint32, m->stack[m->sp - 2].value.uint32,
        m->stack[m->sp - 1].value.uint32, m->stack[m->sp - 0].value.uint32);
    m->sp += -3;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_i_iiiii(Module *m, Block *function, Type *type) {
    uint32_t res = ((uint32_t(*)(uint32_t, uint32_t, uint32_t, uint32_t,
                                 uint32_t))function->func_ptr)(
        m->stack[m->sp - 4].value.uint32, m->stack[m->sp - 3].value.uint32,
        m->stack[m->sp - 2].value.uint32, m->stack[m->sp - 1].value.uint32,
        m->stack[m->sp - 0].value.uint32);
    m->sp += -4;
    m->stack[m->sp].value_type = I32;
...
void thunk_out_0_ffff(Module *m, Block *function, Type *type) {
    ((void (*)(float, float, float, float))function->func_ptr)(
        m->stack[m->sp - 3].value.f32, m->stack[m->sp - 2].value.f32,
        m->stack[m->sp - 1].value.f32, m->stack[m->sp - 0].value.f32);
    m->sp = m->sp + -4;
}
...
void thunk_out_0_FFFFFF(Module *m, Block *function, Type *type) {
    ((void (*)(double, double, double, double, double,
               double))function->func_ptr)(
        m->stack[m->sp - 5].value.f64, m->stack[m->sp - 4].value.f64,
        m->stack[m->sp - 3].value.f64, m->stack[m->sp - 2].value.f64,
        m->stack[m->sp - 1].value.f64, m->stack[m->sp - 0].value.f64);
    m->sp = m->sp + -6;
}
